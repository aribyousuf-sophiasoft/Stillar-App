...
class TrackOrderPurchasingCompleted extends StatefulWidget {
  _TrackOrderPurchasingCompletedState createState() => _TrackOrderPurchasingCompletedState();
}

class _TrackOrderPurchasingCompletedState extends State<TrackOrderPurchasingCompleted> {
  StateModel appState;
                                  ...
                                  child: Stack(
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Image(
                                          image: new AssetImage(
                                              "assets/images/track-order/on-the-way-2.png"),
                                        ),
