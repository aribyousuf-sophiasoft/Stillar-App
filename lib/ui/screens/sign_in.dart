    ...
    final loginButton = Padding(
        padding: EdgeInsets.symmetric(vertical: 18.0),
          child: RaisedButton(
            ...
            child: Text('LOGIN', style: TextStyle(color: Colors.white, fontFamily: 'Poppins', fontWeight: FontWeight.bold)),
          ),
    );
      ...
      child: RaisedButton(
        ...
        child: new Row(
          children: <Widget>[
            ...
            Text('LOGIN WITH FACEBOOK', style: TextStyle(color: Colors.white, fontFamily: 'Poppins', fontWeight: FontWeight.w400))
          ],
        ),
      ),
    );
