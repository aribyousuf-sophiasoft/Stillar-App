...
class TrackOrderRiderArrived extends StatefulWidget {
  _TrackOrderRiderArrivedState createState() => _TrackOrderRiderArrivedState();
}

class _TrackOrderRiderArrivedState extends State<TrackOrderRiderArrived> {
  StateModel appState;
